...
class Schema {
    ...
    object KnownWordTable : BaseColumns{
        const val TABLE = "known_words"
    ...
    fun setup(): List<String> {
        ...
        queries.add("CREATE TABLE IF NOT EXISTS ${WordLocationTable.TABLE} (${WordLocationTable.COLUMN_BOOK_ID} INTEGER NOT NULL, ${WordLocationTable.COLUMN_PARAGRAPH_ID} INTEGER NOT NULL, ${WordLocationTable.COLUMN_WORD_ID} INTEGER NOT NULL, ${WordLocationTable.COLUMN_START} INTEGER NOT NULL, ${WordLocationTable.COLUMN_END} INTEGER NOT NULL, UNIQUE(${WordLocationTable.COLUMN_BOOK_ID},${WordLocationTable.COLUMN_PARAGRAPH_ID},${WordLocationTable.COLUMN_WORD_ID},${WordLocationTable.COLUMN_START},${WordLocationTable.COLUMN_END}));")
